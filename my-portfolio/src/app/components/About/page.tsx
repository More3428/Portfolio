        ...
        <section id="about" className="min-h-screen flex items-center justify-center w-full">
            <div className="flex flex-row items-center justify-center w-full max-w-7xl">
                ...
                <div className="w-1/2 flex flex-col items-center justify-center">
                    ...
                    <h2 className="tracking-tight text-white sm:text-xs  md:text-xl lg:text-2xl font-custom3 relative z-10 pb-2">Software Engineer</h2>
                    ...
                    <div className="text-center text-white px-4 ">
                        ...
                        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-center ">
                            <div className="items-center justify-center">
                                <h2 className="text-3xl sm:text-medium md:text-xl lg:text-2xl font-custom3 p-4 mt-4">Education</h2>
